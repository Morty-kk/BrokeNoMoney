        ...
        <div className="nav-container">
            ...
            <div className="nav-actions">
                <button
                    ...
                    data-theme={theme}
                    aria-label={`Wechsle in den ${theme === "dark" ? "Hellmodus" : "Dark Mode"}`}
                    title={`Wechsle in den ${theme === "dark" ? "Hellmodus" : "Dark Mode"}`}
                >
...
const App = () => {
    ...
    const [hasManualTheme, setHasManualTheme] = React.useState(() => {
        if (typeof window === "undefined") {
            return false;
        }
        return Boolean(window.localStorage.getItem("bnm-theme"));
    });
    ...
    React.useEffect(() => {
        ...
        if (typeof window !== "undefined") {
            if (hasManualTheme) {
                ...
                window.localStorage.removeItem("bnm-theme");
            }
        }
